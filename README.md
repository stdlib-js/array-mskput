...
```javascript
mskput = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-mskput@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-mskput@v0.1.1-umd/browser.js"></script>
```
...
[@stdlib/array/place]: https://github.com/stdlib-js/array-place/tree/umd
